...
const FLASH_SCRIPT = `(function(){try{
  ...
  var A={
    blue:  {'--primary':'217 91% 60%','--primary-hover':'217 91% 55%','--secondary':'200 95% 55%','--ring':'217 91% 60%','--primary-foreground':'0 0% 100%'},
    red:   {'--primary':'0 84% 60%',  '--primary-hover':'0 84% 54%',  '--secondary':'0 90% 70%',  '--ring':'0 84% 60%', '--primary-foreground':'0 0% 100%'},
    green: {'--primary':'142 70% 45%','--primary-hover':'142 70% 40%','--secondary':'160 84% 39%','--ring':'142 70% 45%','--primary-foreground':'0 0% 100%'},
    purple:{'--primary':'270 70% 60%','--primary-hover':'270 70% 54%','--secondary':'280 60% 65%','--ring':'270 70% 60%','--primary-foreground':'0 0% 100%'},
    orange:{'--primary':'25 95% 53%', '--primary-hover':'25 95% 47%', '--secondary':'38 92% 50%', '--ring':'25 95% 53%','--primary-foreground':'0 0% 100%'},
    yellow:{'--primary':'47 96% 53%', '--primary-hover':'47 96% 46%', '--secondary':'54 91% 60%', '--ring':'47 96% 53%','--primary-foreground':'0 0% 8%'},
    grey:  {'--primary':'215 20% 65%','--primary-hover':'215 20% 58%','--secondary':'215 16% 75%','--ring':'215 20% 65%','--primary-foreground':'0 0% 100%'},
    cyan:  {'--primary':'189 94% 43%','--primary-hover':'189 94% 37%','--secondary':'196 100% 47%','--ring':'189 94% 43%','--primary-foreground':'0 0% 100%'},
    tan:   {'--primary':'30 52% 64%', '--primary-hover':'30 52% 57%', '--secondary':'25 60% 72%', '--ring':'30 52% 64%','--primary-foreground':'0 0% 100%'},
    pink:  {'--primary':'330 81% 60%','--primary-hover':'330 81% 54%','--secondary':'316 72% 68%','--ring':'330 81% 60%','--primary-foreground':'0 0% 100%'}
  };
